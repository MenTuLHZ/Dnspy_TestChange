...
namespace dnSpy.Debugger.DotNet.Metadata {
	public abstract class DbgInMemoryModuleService {
	...
	public sealed class DbgInMemoryModuleServiceImpl : DbgInMemoryModuleService, IDbgManagerStartListener {
		...
		public override ModuleDef? LoadModule(DbgModule module) {
			...
			ModuleDef moduleDef = LoadMemoryModule(module);
			Test_Print_Log.Test_Print_Log.isMemoryModule = true;
			return moduleDef;
		}
